...
def _get_search_dirs() -> list:
    ...
    # Source layout:   <root>/src/ghidra/sleigh/ -> 3 levels up = <root>
    ...
    for root in roots:
        # Scan {specs,Ghidra,specroot}/Processors/<proc>/data/languages/
        for specdir_name in ("specs", "Ghidra", "specroot"):
